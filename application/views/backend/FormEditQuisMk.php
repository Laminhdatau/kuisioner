					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form method="post" action="<?= base_url('backend/fungsiEditQuisMk/'); ?><?= $editquis->kd_quisioner; ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
